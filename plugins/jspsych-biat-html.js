 ...
 **/
 ...
 jsPsych.plugins['biat-html'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='font-size: 2em; position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0'><p id='jspsych-iat-stim'>" + trial.stimulus + "</p></div>";
    
    html_str += "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: +75px; left: 0; right: 0'>";

    html_str += "<p>Press " + trial.displayed_categories_key + " for:<br> " +
    trial.upper_category_label.bold() +  " or " +
    trial.lower_category_label.bold() + "</p></div>";
